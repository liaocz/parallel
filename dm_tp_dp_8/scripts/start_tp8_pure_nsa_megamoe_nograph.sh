...
rank="${1:?usage: start_tp8_pure_nsa_megamoe_nograph.sh NODE_RANK}"
log_path="/home/admin/sglang_runs/tp8_pure_nsa_megamoe_nograph_rank${rank}.log"
metrics_dir="/home/admin/sglang_metrics/tp8_pure_nsa_megamoe_nograph"
